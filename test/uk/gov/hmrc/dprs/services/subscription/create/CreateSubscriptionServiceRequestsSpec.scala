...
class CreateSubscriptionServiceRequestsSpec extends BaseSpec {
    ...
    "valid, having" - {
      ...
      "a recognised id type" in {
        ...
        forAll(types) { (_type, expectedRawType) =>
          val expectedType = Request.IdType.all.find(_.toString == expectedRawType).get
          val rawJson =
            s"""
              |{
              |    "id": {
          ...
          "too long" in {
            val rawJson =
              """
                ...
                |    "id": {
                |        "type": "NINO",
                |        "value": "AA000000AAA000000AAA000000A"
                |    },
                |    "name": "Harold Winter",
                |    "contacts": [
                |        {
            ...
            rawJson should beInvalid[Request](Seq((__ \ "id" \ "value", Seq(JsonValidationError(immutable.Seq("error.maxLength"), 15)))))
          }
        }
      }
